...
## Keywords
ZSH_HIGHLIGHT_STYLES[reserved-word]='fg=#31748f'
## Options / parameters
ZSH_HIGHLIGHT_STYLES[single-hyphen-option]='fg=#c4a7e7'
ZSH_HIGHLIGHT_STYLES[double-hyphen-option]='fg=#c4a7e7'
ZSH_HIGHLIGHT_STYLES[autodirectory]='fg=#f6c177,italic'
## Punctuation / separators
ZSH_HIGHLIGHT_STYLES[commandseparator]='fg=#908caa'
ZSH_HIGHLIGHT_STYLES[command-substitution-delimiter]='fg=#908caa'
ZSH_HIGHLIGHT_STYLES[command-substitution-delimiter-unquoted]='fg=#908caa'
ZSH_HIGHLIGHT_STYLES[process-substitution-delimiter]='fg=#908caa'
ZSH_HIGHLIGHT_STYLES[back-quoted-argument-delimiter]='fg=#908caa'
ZSH_HIGHLIGHT_STYLES[redirection]='fg=#908caa'
## Escapes
ZSH_HIGHLIGHT_STYLES[back-double-quoted-argument]='fg=#31748f'
ZSH_HIGHLIGHT_STYLES[back-dollar-quoted-argument]='fg=#31748f'
...
ZSH_HIGHLIGHT_STYLES[path_pathseparator]='fg=#908caa'
ZSH_HIGHLIGHT_STYLES[path_prefix]='fg=#e0def4'
ZSH_HIGHLIGHT_STYLES[path_prefix_pathseparator]='fg=#908caa'
## Fallback
